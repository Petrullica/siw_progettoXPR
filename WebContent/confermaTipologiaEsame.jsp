...
<body>
	<f:view>
		<h:form>
					...
					<div class="row">
						<div class="col-md-6 col-md-offset-3">
							<div class="panel panel-default">
								<h3 style="font-size: 400%;">${indicatoreRisultatoController.tipologiaEsame.nome}</h3>
								...
								<h5 style="font-size: 180%;">
									...
									${indicatoreRisultatoController.tipologiaEsame.descrizione}
								</h5>
								<br>
								<h5 style="font-size: 180%;">
			...
			<div class="container">
				<div>
					<label for="inputText3" class="col-sm-3 control-label">Prerequisiti</label>
					<c:forEach var="string"
						items="#{prerequisitoController.prerequisitiSelezionati}">
						<tr>
							<td>${string}</td>
						</tr>
					</c:forEach>
