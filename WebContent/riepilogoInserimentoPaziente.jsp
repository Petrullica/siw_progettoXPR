...
<body>
	...
	<ul>
		<li>Nome: <b>${PazienteController.paziente.nome}</b></li>
		<li>Cognome: <b>${PazienteController.paziente.cognome}</b></li>
		<li>Username:<b>${PazienteController.paziente.username}</b></li>
	</ul>
</body>
</html>