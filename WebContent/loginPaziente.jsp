		...
		<h:form>
			<div>
				...
				<h:inputText value="#{pazienteController.username}" required="true"
					requiredMessage="Nome is mandatory" id="username" />
				<h:message for="username" />
			</div>
			<div>
				Password:
				<h:inputText value="#{pazienteController.password}" required="true"
					requiredMessage="Descrizione is mandatory" id="password" />
